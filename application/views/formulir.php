            ...
            <script>
              ...
              var dd = {
                header: function() {
                  return {
                    table: {
                      body: [
                        [{
                          image: 'data:image/png;base64,<?= $head; ?>',
                          width: 570,
                          height: 80,
                        }, ]
                      ]
                ...
                content: [
                  ...
                  {
                    text: 'Bissmillahirrahmanirrahiim',
                    style: 'header',
                    alignment: 'center',
                    bold: true
                  },
                  {
                    text: 'FORMULIR PENDAFTARAN SANTRI BARU',
                    style: 'header',
                    alignment: 'center',
                    bold: true
                  },
                  {
                    text: 'TAHUN PELAJARAN 2017 /2018',
                    style: 'header',
                    alignment: 'center',
                    bold: true
                  },
                ...
                <?php foreach ($surat as $mail) { ?>
                  ...
                  {
                    text: 'SURAT PERNYATAAN PELIMPAHAN PENDIDIKAN',
                    style: 'header',
                    alignment: 'center',
                    bold: true
                  },
                  {
                    text: 'DAN KESEDIAAN DANA ORANG TUA/WALI CALON SISWA',
                    style: 'header',
                    alignment: 'center',
                    bold: true
                  },
                  ...
                  {
                    text: "Dengan ikhlas menginfakan dana pendidikan kepada Pesantren Tahfidzul Qur'an Al Azzam SMP IT Bina Insani:",
                    margin: [20, 3, 30, 5],
                    fontSize: 12
                  },
                  {
                  ...
                  {
                    text: 'A. Penyelesaian Kesediaan Dana Pendidikan tersebut di atas dengan ketentuan sebagai berikut:',
                    bold: true,
                    margin: 5
                  },
                  {
                    text: 'Pembayaran pertama saat daftar ulang menyelesaikan :',
                    margin: [25, 3, 30, 5]
                  },
                  {
                    margin: [35, 3, 30, 5],
                  ...
                  {
                    text: 'Pelunasan sisa kesediaan Dana Pendidikan paling lambat bulan Desember 2017.',
                    margin: [25, 3, 30, 5]
                  },
                  {
                    text: 'B. Selaku Orang tua/wali siswa tersebut denan sungguh-sungguh penuh kesadaran kami menyatakan bahwa :',
                    bold: true,
                    margin: 5
                  },
                  {
                  ...
                  {
                    text: "Demikian pernyataan ini kami buat, semoga memberikan manfaat yang sebesar-besarnya pada pendidikan putra/putri kami dan mendapatkan ridho Allah Subhanallahu Wa Ta'ala. Amiin",
                    margin: [25, 3, 30, 5]
                  },
                  {
                    text: '',
                ...
                ?>
                  ...
                  //Pendidikan
                  {
                    ...
                    columns: [{
                      ...
                      {
                        image: 'data:image/png;base64,<?= $img3; ?>',
                        width: 200
                      },
                    ],
                  },
