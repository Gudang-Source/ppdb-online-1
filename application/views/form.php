                ...
                <div id="wizard" class="form_wizard wizard_horizontal">
                  ...
                  <div id="step-6">
                    <form class="form-horizontal form-label-left">
                      ...
                      <h2>
                        <center>SURAT PERNYATAAN PELIMPAHAN PENDIDIKAN</center>
                      </h2>
                      <h2>
                        <center>DAN KESEDIAAN DANA ORANG TUA/WALI CALON SISWA</center>
                      </h2>
                      <h2>
                        <center>TAHUN PELAJARAN 2017/2018</center>
                      </h2>
                      <div class="form-group">
                      ...
                      <ol>
                        ...
                        <strong>
                          <ul class="col-md-3">Jumlah Total</ul><span class="glyphicon glyphicon-flag"> Rp. 10.575.000</span>
                        </strong>
                      </ol>
                  ...
                  <div id="step-7">
                    <h1>
                      <center> KARTU PENDAFTARAN</center>
                    </h1>
                    <form class="form-horizontal form-label-left">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nomor Pendaaftaran <span class="required">*</span>
